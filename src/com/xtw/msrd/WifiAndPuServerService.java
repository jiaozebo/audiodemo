...
public class WifiAndPuServerService extends Service {
	...
	public void onCreate() {
		...
		Log.e(SMS_PWD, "oncreate before init root!");
		G.initRoot();
		if (G.sRootPath == null) {
			Log.e(SMS_PWD, "init root error!");
	...
	public int onStartCommand(Intent intent, int flags, int startId) {
		...
		if (startAudio) {
			if (entity != null && Environment.MEDIA_MOUNTED.equals(G.getStorageState())) {
				// 默认录像
				if (G.sIsAbortToRecordAfterMounted)
